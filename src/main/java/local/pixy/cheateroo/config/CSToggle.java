...
public enum CSToggle implements IHotkeyTogglable, IConfigNotifiable<IConfigBoolean> {
	...
	private CSToggle(String name, boolean defaultValue, String defaultHotkey, String comment) {
	...
	private CSToggle(String name, boolean defaultValue, String defaultHotkey, KeybindSettings settings,
			String comment) {
	...
	private CSToggle(String name, boolean defaultValue, String defaultHotkey, String comment, String prettyName) {
